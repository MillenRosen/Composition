...
The `soundTrack` function makes it easy and quick to insert notes into the timeline, provided you have done all the previous preparations. You can also use external audio sources (like 钢琴 88), which should be stored in cells if pitche changes.
